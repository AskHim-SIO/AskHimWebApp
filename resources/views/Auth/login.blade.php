...
@section('content')
    ...
    <div class="h-screen md:flex">
        ...
        <div class="flex w-1/2 justify-center items-center bg-white">
            <form class="bg-white" action="{{route("login.connect")}}" method="POST">
                @csrf
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                    ...
                    <div>
                        <button class="pt-2 pl-2" onclick="visibility3()" type='button' type="button" value=""><span class='material-icons md-18'>visibility</span></button>
                    </div>
                </div>
