...
@section('navbar')
    ...
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            ...
            {{--               </button>--}}
            <!-- Pas de connection-->
                <button type="button" class="text-white bg-askHimBlue hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Se connecter
                </button>
                <button type="button"
                        class="text-gray-900 bg-askHim-blue border border-gray-300 hover:bg-gray-100 focus: font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">
                    S'inscrire
                </button>
