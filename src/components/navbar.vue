    ...
    <div class="bg-white shadow">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between py-4">
          <div>
            <router-link to="/"><svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-purple-600" viewBox="0 0 24 24">
          ...
          <div class="hidden sm:flex sm:items-center">
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4"><router-link to="/rechercher">Rechercher</router-link></a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4"><router-link to="/ajouter-service">Ajouter un </router-link></a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4"><router-link to="/savoir-plus">Ajouter un </router-link></a>
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600"><router-link to="/contact">Contact </router-link></a>
          </div>

          <div class="hidden sm:flex sm:items-center">
            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4"><router-link to="/se-connecter">Se connecter </router-link></a>
            <a href="#" class="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600"><router-link to="/connexion">Se connecter </router-link></a>
          </div>
