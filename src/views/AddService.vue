...
export default {
    ...
    checkForm: function (e) {
      ...
      if (!this.errors.length) {
        ...
        if (this.selected.libelle === "Transport") {
          ...
          axios.post('https://api.askhim.ctrempe.fr/service/create-transport-service', this.addTransport)
              .then((res) => {
                ...
                if (this.images) {
                  const arr = this.images.map(file => readFile(file)
                      .then(contenu => {
                            ...
                            axios.post(`https://api.askhim.ctrempe.fr/photo/save-photo-to-service?serviceId=${res.data}`, this.jsonImg)
                          }
                      ))
        ...
        if (this.selected.libelle === "Formation") {
          ...
          axios.post('https://api.askhim.ctrempe.fr/service/create-formation-service', this.addFormation)
              .then((res) => {
        ...
        if (this.selected.libelle === "Loisir") {
          ...
          axios.post('https://api.askhim.ctrempe.fr/service/create-loisir-service', this.addLoisir)
              .then((res) => {
        ...
        if (this.selected.libelle === "Course") {
          ...
          axios.post('https://api.askhim.ctrempe.fr/service/create-course-service', this.addCourse)
              .then((res) => {
        ...
        if (this.selected.libelle === "Tâche ménagère") {
          ...
          axios.post('https://api.askhim.ctrempe.fr/service/create-tachemenagere-service', this.addTacheMenagere)
              .then((res) => {
  ...
  mounted() {
    ...
    axios.get(`https://api.askhim.ctrempe.fr/user/get-user-by-token/${store.state.guid}`)
        .then(res => {
