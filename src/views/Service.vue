...
export default {
  ...
  methods: {
    initMessage() {
      axios
          .post(`https://api.askhim.ctrempe.fr/chat/init-discussion?serviceId=${this.id}&userToken=${store.state.guid}`)
          .then((res) => {
            this.$router.push({
              name: 'Chat',
  ...
  mounted() {
    axios
        .get('https://api.askhim.ctrempe.fr/service/get-service/' + this.id)
        .then(response => {
    ...
    axios
        .get(`https://api.askhim.ctrempe.fr/user/get-user-by-token/${store.state.guid}`)
        .then(res => {
          axios
              .get(`https://api.askhim.ctrempe.fr/service/get-services-from-user-by-id/${res.data.id}`)
              .then((res) => {
